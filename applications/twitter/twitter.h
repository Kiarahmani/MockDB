...
void twitter::add_user(user u) {
    ...
    user_list["list"][user_count] = (web::json::value) (int) u.get_id();
...
void twitter::follow(user a, user b) {
    ...
    following["list"][following_count] = (web::json::value)(int) b.get_id();
    ...
    followers["list"][follower_count] = (web::json::value) (int) a.get_id();
...
void twitter::publish_tweet(user u, tweet t) {
    ...
    tweets["list"][tweets_count] = (web::json::value) (int) t.get_id();
    ...
    tweet["content"] = web::json::value(utility::conversions::to_string_t(t.get_tweet()));
    tweet["timestamp"] = web::json::value( (int) t.get_timestamp());
    tweet["likes"] = web::json::value((int) t.get_likes());
    tweet["retweets"] = web::json::value((int) t.get_retweets());
...
std::vector<tweet> twitter::_get_timeline(long user_id, long session_id) {
    ...
    for (auto &t : tweets["list"].as_array()) {
        ...
        tweet tweet_obj(t.as_integer(), utility::conversions::to_utf8string(tweet_json["content"].as_string()), tweet_json["timestamp"].as_integer());
